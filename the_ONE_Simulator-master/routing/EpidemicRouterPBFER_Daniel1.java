 ...
 */
public class EpidemicRouterPBFER_Daniel1 extends ActiveRouter {
     ...
     */
    public EpidemicRouterPBFER_Daniel1(Settings s) {
        super(s);
        String fclString = s.getSetting(FCL_NAMES);
        fcl = FIS.load(fclString);
    }

    protected EpidemicRouterPBFER_Daniel1(EpidemicRouterPBFER_Daniel1 r) {
        super(r);
        this.fcl = r.fcl;
    }
    ...
    private void exchangeMessageProperty() {
        ...
        for (Connection conn : getConnections()) {
            ...
            EpidemicRouterPBFER_Daniel1 otherHost = (EpidemicRouterPBFER_Daniel1) other.getRouter();
	...
	this.sortByQueueMode(messages); //kalau asli dari activeRouter memakai ini.
        ...
        for (Connection c : connections) {
            ...
            EpidemicRouterPBFER_Daniel1 peer = (EpidemicRouterPBFER_Daniel1) otherhost.getRouter();
...
//                System.out.println(getHost().getBufferOccupancy()+"||"+otherhost.getRouter().getFreeBufferSize()); // untuk nge cek
    ...
    protected List<Message> getMergedSortMessage() {
        ...
        for (Connection c : getConnections()) {
            ...
            EpidemicRouterPBFER_Daniel1 peer = (EpidemicRouterPBFER_Daniel1) other.getRouter();
    ...
    @Override
    public EpidemicRouterPBFER_Daniel1 replicate() {
        return new EpidemicRouterPBFER_Daniel1(this);
    }
