...
public abstract class MessageRouter {
    ...
    public MessageRouter(Settings s) {
        ...
        if (s.contains(SEND_QUEUE_MODE_S)) {
            ...
            sendQueueMode = Q_MODE_RANDOM; //mengubah urutan pengiriman
        }
...
//        }
    ...
    protected boolean isDeliveredMessage(Message m) {
        ...
        //@return benar jika pesan dengan ID yang sama telah diterima oleh host ini sebagai penerima akhir.
    }
     ...
     */
    //Metode ini harus dipanggil (pada host penerima) setelah pesan 
    //berhasil ditransfer. Pesan yang ditransfer dimasukkan ke buffer 
    //pesan kecuali host ini adalah penerima akhir pesan.
