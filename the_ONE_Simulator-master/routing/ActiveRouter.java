...
//                connections1 = connections.toArray(connections1);
	...
	protected Connection exchangeDeliverableMessages() {
		List<Connection> connections = getConnections();
                // mendapatkan daftar koneksi saat ini yang dimiliki node tersebut. 

		if (connections.size() == 0) { // jika ukuran daftar koneksi 0 artinya tidak ada pesan yang bisa di pertukarkan karena tidak ada koneksi
			return null; //maka return null
		}
